...
HD_PWD='D:/Ferris-Prima-Nugraha/HKUST/2020Fall/ELEC3310/miniproject_826/miniproject_826.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sequence_detector_826.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sequence_detector_826.tcl -notrace
