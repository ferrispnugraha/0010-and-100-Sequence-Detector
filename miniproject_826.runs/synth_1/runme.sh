...
HD_PWD='D:/Ferris-Prima-Nugraha/HKUST/2020Fall/ELEC3310/miniproject_826/miniproject_826.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sequence_detector_826.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sequence_detector_826.tcl
